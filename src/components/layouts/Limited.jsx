...
const Items = ({ itemName, price, img,orgPR,className }) => {
  return (
    <>
      <div className="w-[330px] relative group cursor-pointer">
        <Images src={img} />
        <div className="py-[10px]">
          <div className="flex justify-between">
            <div className="">
              ...
              <div className="flex">
                <p className={`text-[16px] font-Menu ${className}`}><span><del className="text-black font-semibold">{orgPR}</del></span>{`$${price}`}</p>
              </div>
            </div>
...
const Limited = () => {
  ...
  return (
    <>
      ...
      <div>
        <Items img={item2} itemName={"Hosking Blue Area Rug"} price={"62"} />
      </div>
      <div>
        <Items img={item3} itemName={"Hanneman Pouf"} price={"17"} />
      </div>
      <div>
        <Items img={item4} itemName={"Cushion Futon Slipcover"} price={"99"} orgPR={"$122"} className={"text-red-500 font-bold"} />
      </div>
      <div>
        <Items img={item1} itemName={"Hub Accent Mirror"} price={"29"} />
      </div>
